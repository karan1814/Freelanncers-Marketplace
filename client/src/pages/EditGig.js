...
const EditGig = () => {
  ...
  const updateGigMutation = useMutation(
    (gigData) => axios.put(`/api/gigs/${id}`, gigData),
    {
      onSuccess: () => {
  ...
  const onSubmit = async (data) => {
    ...
    updateGigMutation.mutate(gigData);
  };
    ...
    <div className="max-w-4xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">
          Update your gig information to attract more clients.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
        ...
        <div className="flex justify-end space-x-4">
          ...
          <button
            type="submit"
            disabled={updateGigMutation.isLoading}
            className="btn btn-primary"
          >
            {updateGigMutation.isLoading ? 'Updating...' : 'Update Gig'}
          </button>
        </div>
      </form>
    </div>
